	...
	<div class="wrap">
		...
		<div class="span12 well">
			...
			<div id="myCarousel" class="carousel slide" style="width:600px; float:left;margin-bottom:3px;">		
				...
				<div class="active item"><img src="images/6i.jpg" style="width:600px;height:350px;"/></div>
				<div class="item"><img src="images/7i.jpg" style="width:600px;height:350px;"/> </div>
				<div class="item"><img src="images/8i.jpg" style="width:600px;height:350px;"/></div>
				<div class="item"><img src="images/9i.jpg" style="width:600px;height:350px;"/></div>
				<div class="item"><img src="images/10i.jpg" style="width:600px;height:350px;"/> </div>
				<div class="item"><img src="images/11i.jpg"style="width:600px;height:350px;"/></div>
...
<footer >
		<div style="width:100%;">
			...
			<p class="text-right text-info">	Designed For DBMS Project</p>
			</div>
		</div>
		</footer>	</div>
